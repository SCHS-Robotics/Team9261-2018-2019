...
@Autonomous(name="Crater",group="Harry Potter Reference")
public class CraterAuto extends LinearOpMode implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void runOpMode() {
        ...
        if(movedLeft) { //1: Left
            drive(new Vector(-0.6,0),800);// go back
            drive(new Vector(0,0.6),1000); //drive sideways
            //sleep(1000);
            turnPID(0.7,45,0.75);
            //sleep(1000);
            drive(new Vector(0,0.6),3000); //drive to depot
            sleep(200);
            raskolnikov();
            sleep(200);

            //begin return to crater

            drive(new Vector(0,-1.2),4800); //drive back to crater
            stopMotors();
        }
        else if (Math.abs(avg) > 1e-6) { //2: Right
            drive(new Vector(-0.6,0),900);//go back
            //sleep(1000);
            drive(new Vector(0,0.8),3700);//go sideways
            //sleep(1000);
            turnPID(0.7,45,1);
            //sleep(1000);
            drive(new Vector(0,0.8),3000); //drive towards depot
            sleep(200);
            raskolnikov();
            sleep(200);

            //begin return to crater
            drive(new Vector(0,-1.2),4800); //drive to crater
/*
            drive(new Vector(0,-0.6),1800);
            //sleep(1000);
            turnPID(0.7,0,1);
            //sleep(1000);
            drive(new Vector(0,-0.6),2200);
           // sleep(1000);
            turnPID(0.7,-90,1);
            //sleep(1000);
            drive(new Vector(0,0.8),2000);
            //sleep(1000);
            */
            stopMotors();
        }
        else { // 3: Center
            drive(new Vector(-0.6,0),800); //drive backwards
            drive(new Vector(0,0.8),2200); //drive sideways
            turnPID(0.7,45,1);
            drive(new Vector(0,0.8),3000); //drive to depot
            sleep(200);
            raskolnikov();
            sleep(200);
            ...
            /*
            turnPID(0.7,0,1);
            drive(new Vector(0,-0.6),1100);
            turnPID(0.7,-90,1);
            drive(new Vector(0,0.8),1000);
            */
            stopMotors();
    ...
    public void turnPID(double velocity, double angle, double threshold) {
        ...
        while (Math.abs(error) > threshold && opModeIsActive()) {
            ...
            //Counter Clockwise; sets all the correction values
